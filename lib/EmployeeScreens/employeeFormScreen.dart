  ...
  if(clientsDropdownvalue != null
        ...
        .then((documentSnapshot) async
    {
      if(documentSnapshot.exists){
        ...
        await Navigator.push(context, MaterialPageRoute(builder: (c) => EmployeeFormScreen()));
      }
    });
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              if (constraints.maxWidth < 600) {
                return const EmployeeFormMobile();
              } else if (constraints.maxWidth > 600 && constraints.maxWidth < 900) {
                return const EmployeeFormMobile();
              } else {
                return const EmployeeFormDesktop();
              }
            },
          )
        ],
...
class EmployeeFormMobile extends StatefulWidget {
  const EmployeeFormMobile({Key? key}) : super(key: key);

  @override
  State<EmployeeFormMobile> createState() => _EmployeeFormMobileState();
}

class _EmployeeFormMobileState extends State<EmployeeFormMobile> {
  @override
  Widget build(BuildContext context) {
...
class EmployeeFormDesktop extends StatefulWidget {
  const EmployeeFormDesktop({Key? key}) : super(key: key);

  @override
  State<EmployeeFormDesktop> createState() => _EmployeeFormDesktopState();
}

class _EmployeeFormDesktopState extends State<EmployeeFormDesktop> {
  @override
  Widget build(BuildContext context) {

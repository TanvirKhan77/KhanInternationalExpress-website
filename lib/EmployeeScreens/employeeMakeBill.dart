...
import '../ExcelTest/excelTest.dart';
...
class EmployeeMakeBillScreen extends StatefulWidget {
  const EmployeeMakeBillScreen({Key? key}) : super(key: key);

  @override
  State<EmployeeMakeBillScreen> createState() => _EmployeeMakeBillScreenState();
}

class _EmployeeMakeBillScreenState extends State<EmployeeMakeBillScreen> {
  @override
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              if (constraints.maxWidth < 600) {
                return const EmployeeMakeBillMobile();
...
class EmployeeMakeBillMobile extends StatefulWidget {
  const EmployeeMakeBillMobile({Key? key}) : super(key: key);

  @override
  State<EmployeeMakeBillMobile> createState() => _EmployeeMakeBillMobileState();
}

class _EmployeeMakeBillMobileState extends State<EmployeeMakeBillMobile> {
  @override
  Widget build(BuildContext context) {
...
class EmployeeMakeBillDesktop extends StatefulWidget {
  const EmployeeMakeBillDesktop({Key? key}) : super(key: key);

  @override
  State<EmployeeMakeBillDesktop> createState() => _EmployeeMakeBillDesktopState();
}

class _EmployeeMakeBillDesktopState extends State<EmployeeMakeBillDesktop> {
  @override
  Widget build(BuildContext context) {

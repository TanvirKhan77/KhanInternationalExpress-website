...
class EmployeeClientsServicesScreen extends StatefulWidget {
  const EmployeeClientsServicesScreen({Key? key}) : super(key: key);

  @override
  State<EmployeeClientsServicesScreen> createState() => _EmployeeClientsServicesScreenState();
}

class _EmployeeClientsServicesScreenState extends State<EmployeeClientsServicesScreen> {
  @override
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              if (constraints.maxWidth < 600) {
                return const EmployeeClientsServicesMobile();
              } else if (constraints.maxWidth > 600 && constraints.maxWidth < 900) {
                return const EmployeeClientsServicesMobile();
              } else {
                return const EmployeeClientsServicesDesktop();
              }
            },
          ),
        ],
...
class EmployeeClientsServicesMobile extends StatefulWidget {
  const EmployeeClientsServicesMobile({Key? key}) : super(key: key);

  @override
  State<EmployeeClientsServicesMobile> createState() => _EmployeeClientsServicesMobileState();
}

class _EmployeeClientsServicesMobileState extends State<EmployeeClientsServicesMobile> {
...
class EmployeeClientsServicesDesktop extends StatefulWidget {
  const EmployeeClientsServicesDesktop({Key? key}) : super(key: key);

  @override
  State<EmployeeClientsServicesDesktop> createState() => _EmployeeClientsServicesDesktopState();
}

class _EmployeeClientsServicesDesktopState extends State<EmployeeClientsServicesDesktop> {

          ...
          LayoutBuilder(
            builder: (context, constraints) {
              if (constraints.maxWidth < 600) {
                return const EmployeeProfileMobile();
...
class EmployeeProfileMobile extends StatefulWidget {
  const EmployeeProfileMobile({Key? key}) : super(key: key);

  @override
  State<EmployeeProfileMobile> createState() => _EmployeeProfileMobileState();
}

class _EmployeeProfileMobileState extends State<EmployeeProfileMobile> {

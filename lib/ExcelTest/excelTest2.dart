...
class ExcelTest2 extends StatefulWidget {
  const ExcelTest2({Key? key}) : super(key: key);

  @override
  State<ExcelTest2> createState() => _ExcelTest2State();
}

class _ExcelTest2State extends State<ExcelTest2> {
  ...
  List<Employee> _getEmployeeData() {
    return <Employee>[
      ...
      Employee(10010, 'Baal', 'Saal', 15000)
    ];
  }
}

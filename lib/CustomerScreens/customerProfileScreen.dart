...
import 'package:khanintlexpress/CustomerScreens/Components/customerSideMenu.dart';
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              if (constraints.maxWidth < 600) {
                return const CustomerProfileMobile();
              } else if (constraints.maxWidth > 600 && constraints.maxWidth < 900) {
                return const CustomerProfileMobile();
              } else {
                return const CustomerProfileDesktop();
              }
            },
          )
        ],
...
class CustomerProfileMobile extends StatefulWidget {
  const CustomerProfileMobile({Key? key}) : super(key: key);

  @override
  State<CustomerProfileMobile> createState() => _CustomerProfileMobileState();
}

class _CustomerProfileMobileState extends State<CustomerProfileMobile> {
...
class CustomerProfileDesktop extends StatefulWidget {
  const CustomerProfileDesktop({Key? key}) : super(key: key);

  @override
  State<CustomerProfileDesktop> createState() => _CustomerProfileDesktopState();
}

class _CustomerProfileDesktopState extends State<CustomerProfileDesktop> {

...
class FormHelper {
  ...
  static Widget dropDownWidgetCountry(
      BuildContext context,
      String hintText,
      dynamic value,
        ...
        builder: (FormFieldState<dynamic> state) {
          return DropdownButtonFormField<String>(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: Icon(Icons.map,color: MediaQuery.of(context).platformBrightness == Brightness.dark ? Colors.amber : Colors.grey,),
              filled: true,
              fillColor: MediaQuery.of(context).platformBrightness == Brightness.dark ? Colors.black45 : Colors.grey.shade200,
              border: OutlineInputBorder(
            ...
            //   return <String>[lstData.toString()].map((String value) {
            //     return Text(
            //       value,
  ...
  static Widget dropDownWidgetWeight(
      BuildContext context,
      String hintText,
      dynamic value,
      List<dynamic> lstData,
      ...
      child: FormField<dynamic>(
        builder: (FormFieldState<dynamic> state) {
          return DropdownButtonFormField<String>(
            ...
            // selectedItemBuilder: (BuildContext context) { //<-- SEE HERE
            //   return <String>[lstData[]].map((String value) {
            //     return Text(
            //       value,
            //       style: const TextStyle(color: Colors.grey, fontSize: 13),
            //     );

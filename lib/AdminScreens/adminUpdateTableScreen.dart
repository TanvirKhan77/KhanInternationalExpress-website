...
class AdminUpdateTableScreen extends StatefulWidget {
  ...
  @override
  State<AdminUpdateTableScreen> createState() => _AdminUpdateTableScreenState(
    clients,date,shipment_type,airwaybill_no,country,weight,service,amount,amount_status,note,
  );
}

class _AdminUpdateTableScreenState extends State<AdminUpdateTableScreen> {
...
class AdminUpdateTableMobile extends StatefulWidget {
  String? clients,shipment_type,airwaybill_no,country,weight,service,amount,amount_status,note;
  DateTime? date;

  AdminUpdateTableMobile(
      this.clients,
      this.date,
      this.shipment_type,
      this.airwaybill_no,
  ...
  @override
  State<AdminUpdateTableMobile> createState() => _AdminUpdateTableMobileState(
    clients,date,shipment_type,airwaybill_no,country,weight,service,amount,amount_status,note,
  );
}

class _AdminUpdateTableMobileState extends State<AdminUpdateTableMobile> {
